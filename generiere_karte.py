...
# Feste Liste von idealerweise eindeutigen, nicht zu kurzen Namen für
# die Dictionaries. Diese Liste muss man vielleicht an sein eigenes
# Textadventure anpassen!
dicts = [
...
def parse_direction(zeile):
    ...
    if rest.rstrip()[-1] == '\\':
        print(
            f"Fehler: Fortsetzungszeichen erkannt. Deine Karte wird nicht vollständig sein."
        )
        listenende = -2
